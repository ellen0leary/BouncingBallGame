...
int main()
{
    ...
    while (window.isOpen())
    {
        ...
        if (/*event.key.code == sf::Keyboard::Left*/ sf::Keyboard::isKeyPressed(sf::Keyboard::Left)) {
        //move left
        player.move.moveLeft();
                }
        else if (/*event.key.code == sf::Keyboard::Right*/sf::Keyboard::isKeyPressed(sf::Keyboard::Right)) {
        //move right
        player.move.moveRight();
                }
